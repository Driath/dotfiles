...
ACTIVE_GIT='#{?GITMUX_REPO,#[fg=#{@color-separator}]│ #[fg=#{@color-info}]󰘬 #[fg=#{@color-text}]#{GITMUX_BRANCH}#{?GITMUX_CLEAN,, #[fg=#{@color-warning}]●}#{?#{>:#{GITMUX_COMMITS_AHEAD},0}, #[fg=#{@color-warning}]↑#{GITMUX_COMMITS_AHEAD},} ,}'
...
INACTIVE_GIT='#{?GITMUX_REPO,#[fg=#{@color-inactive}]│ 󰘬 #{GITMUX_BRANCH}#{?GITMUX_CLEAN,, ●}#{?#{>:#{GITMUX_COMMITS_AHEAD},0}, ↑#{GITMUX_COMMITS_AHEAD},} ,}'
