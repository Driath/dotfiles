...
ACTIVE_GIT='#{?GITMUX_REPO,#[fg=#{@color-separator}]│ #[fg=#{@color-info}]󰘬 #[fg=#{@color-text}]#{GITMUX_BRANCH}#{?GITMUX_CLEAN,, #[fg=#{@color-warning}]+#{GITMUX_STAGED} ~#{GITMUX_CHANGED} ?#{GITMUX_UNTRACKED}} ,}'
